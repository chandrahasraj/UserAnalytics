...
public class KinesisSpoutConfig implements Serializable {
    ...
    private long zookeeperSessionTimeoutMillis ;
     ...
     * @param zOOKEEPER_SESSIONTIMEOUT Timeout for ZK session.
     * @param cHECKPOINT_INTERVAL Save checkpoint to Zookeeper this often.
    ...
    public KinesisSpoutConfig(final String streamName,
            ...
            final long zOOKEEPER_SESSIONTIMEOUT,
            final long cHECKPOINT_INTERVAL,
        ...
        this.zookeeperConnectionString = zookeeperConnectionString;
        checkValueIsPositive(zOOKEEPER_SESSIONTIMEOUT, "zookeeperSessionTimeoutMillis");
        this.zookeeperSessionTimeoutMillis = zOOKEEPER_SESSIONTIMEOUT;
        checkValueIsPositive(cHECKPOINT_INTERVAL, "checkpointIntervalMillis");
        this.checkpointIntervalMillis = cHECKPOINT_INTERVAL;
    }

    private void checkValueIsPositive(long argument, String argumentName) {
        if (argument <= 0l) {
